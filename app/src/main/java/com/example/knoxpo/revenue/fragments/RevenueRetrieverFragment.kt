...
import com.example.knoxpo.revenue.model.RevenueModel


class RevenueRetrieverFragment : ListFragment<RevenueModel, RevenueRetrieverFragment.RevenueHolder>() {

    private val revenueItems: MutableList<RevenueModel> = mutableListOf()
    override fun onCreateViewHolder(view: View, viewType: Int): RevenueHolder {

        return RevenueHolder(view)
    }

    override fun onBindViewHolder(holder: RevenueHolder, item: RevenueModel?) {
        holder.bind(item!!)
