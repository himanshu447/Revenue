...
import com.example.knoxpo.revenue.fragments.*
import kotlinx.android.synthetic.main.activity_main.*

class MainActivity : AppCompatActivity() {

    private val tabIcons = intArrayOf(R.drawable.home, R.drawable.calendar, R.drawable.settings,R.drawable.home)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tabPagerAdapter.addFragment(NewItemFragment(),getString(R.string.calender))
        tabPagerAdapter.addFragment(TransactionFragment(),getString(R.string.settings))
        tabPagerAdapter.addFragment(InstallmentFragment(),getString(R.string.settings))
